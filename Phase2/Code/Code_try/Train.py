...
from Network.Network import HomographyModel, LossFn, HNet
import cv2
import sys
import os
import numpy as np
...
def main():
    ...
    Parser.add_argument('--CheckPointPath', default='../Checkpoints/ResNeXt/', help='Path to save Checkpoints, Default: ../Checkpoints/ResNeXt')
    Parser.add_argument('--NumEpochs', type=int, default=50, help='Number of Epochs to Train for, Default:50')
    Parser.add_argument('--DivTrain', type=int, default=1, help='Factor to reduce Train data by per epoch, Default:1')
    Parser.add_argument('--MiniBatchSize', type=int, default=1, help='Size of the MiniBatch to use, Default:128')
    Parser.add_argument('--LoadCheckPoint', type=int, default=0, help='Load Model from latest Checkpoint from CheckPointsPath?, Default:0')
    Parser.add_argument('--LogsPath', default='Logs/ResNeXt/', help='Path to save Logs for Tensorboard, Default=Logs/modified')
